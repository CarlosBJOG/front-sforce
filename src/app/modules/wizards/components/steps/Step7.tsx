...
const Step7: FC = () => {
  ...
  return (
    ...
    <div className='fv-row mb-10 mt-3'>
      ...
      <Field type="text" name='namefull2' className='form-control form-control-lg form-control-solid' />
      <div className='text-danger mt-2'>
        <ErrorMessage name='namefull2' />
      </div>
    </div>
